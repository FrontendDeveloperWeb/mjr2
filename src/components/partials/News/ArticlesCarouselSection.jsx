...
// Page-isolated copy for the News page. Kept separate from the Home carousel so
// News-specific changes can never regress the Home page (architecture standards,
// rule 1 — strict page isolation).
