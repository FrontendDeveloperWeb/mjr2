// Page-isolated copy for the News page (see architecture standards: partials
// must never be shared across pages). Spreads {...rest} onto the root node so
// AntD's Carousel can clone its slide-sizing props (style, tabIndex, etc.)
