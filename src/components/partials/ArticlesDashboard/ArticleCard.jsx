...
export default function ArticleCard({ article }) {
  ...
  const tabItems = [
    ...
    { key: 'graphical', label: 'Graphical abstract', children: <div className='d-flex align-items-center '><img src={article.graphicalAbstract} alt="" /><div className='ms-4'>  <PaneHeading>Abstract</PaneHeading> <p>{article.graphicalAbstractDescription} </p></div></div> },
  ];
